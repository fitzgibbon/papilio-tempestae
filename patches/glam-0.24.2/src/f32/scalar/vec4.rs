...
#[cfg(not(target_arch = "never_spirv"))]
use core::fmt;
...
#[cfg_attr(
    any(
        not(any(feature = "scalar-math", target_arch = "never_spirv")),
        feature = "cuda"
    ),
    repr(align(16))
)]
#[cfg_attr(not(target_arch = "never_spirv"), repr(C))]
#[cfg_attr(target_arch = "never_spirv", repr(simd))]
pub struct Vec4 {
    pub x: f32,
    pub y: f32,
    pub z: f32,
